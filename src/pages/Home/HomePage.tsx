    ...
    >
      ...
      <section className="relative overflow-hidden bg-neutral-50">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 right-0 w-96 h-96 bg-brand-100 rounded-full blur-3xl opacity-50 -translate-y-1/2 translate-x-1/2" />
        ...
        <div className="relative container-wide py-12 md:py-20">
          <div className="max-w-3xl">
            ...
            <h1 className="heading-1 mb-4">
              Bangladesh Diaspora
              <span className="text-brand-600"> Bond Calculator</span>
            </h1>
            
            <p className="subheading mb-8 max-w-2xl">
              Calculate your investment returns on NRB Bonds. Get up to <span className="font-semibold text-brand-600">12% tax-free</span> returns on Wage Earner Development Bond.
            </p>
      ...
      <section className="relative -mt-8 md:-mt-10 z-10">
        <div className="container-wide">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            {[
              { value: '12%', label: 'Max WEDB Rate', color: 'text-brand-600' },
              { value: '7.5%', label: 'USD Premium Rate', color: 'text-purple-600' },
              { value: '6.5%', label: 'USD Investment Rate', color: 'text-blue-600' },
              { value: '100%', label: 'Tax Exempt', color: 'text-amber-600' },
            ].map((stat, i) => (
      ...
      <section className="section bg-white border-y border-neutral-200">
        <div className="container-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {(Object.keys(BOND_DATA) as BondType[]).map((bondType) => {
              ...
              const colors = {
                WEDB: { bg: 'bg-brand-50', border: 'border-brand-200', text: 'text-brand-700', badge: 'badge-success' },
                USDIB: { bg: 'bg-blue-50', border: 'border-blue-200', text: 'text-blue-700', badge: 'badge-info' },
                USDPB: { bg: 'bg-purple-50', border: 'border-purple-200', text: 'text-purple-700', badge: 'bg-purple-100 text-purple-700 border-purple-200' },
              }[bondType];
                ...
                <div key={bondType} className="card-interactive p-6">
                  ...
                  <div className="space-y-2 mb-6">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">{bond.tenure} Years</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-neutral-500">Repatriation</span>
                      <span className="font-medium text-xs">{bond.repatriation.split('(')[0]}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-neutral-500">Tax Status</span>
                      <span className="font-medium text-brand-600">Exempt</span>
                    </div>
                  </div>
